...
int solarsystem(Spacecraft &s, double &a1, double &a2, int &p)
{
  ...
  out.open ("spacecraft.txt");
    ...
    // planets[0] = Planet(4.87e24, .001, 3.39471, 0.719257101866, 164.8906, 3.3930, 76.68069, 54.85229, 116.75, 0.00677323,0.72333199, //Venus
    ...
    //planets[0] = Planet(5.972e24, 1, 0.00005, 1.01014351904246, 335.1159, 0.0009, -11.26064, 114.20783, 365.2, 0.01671022, 1,
   ...
   // planets[0] = Planet(102e24, 1, 1.76917, 29.93486047576, 346.9602, -1.0202 , 131.72169, -86.75034, 60225, 0.00858587, 30.06896348,
