...
int solarsystem(Spacecraft &s, double &a1, double &a2, int &p)
{
  ...
  out.open ("spacecraft.txt");
    ...
    // planets[0] = Planet(4.87e24, 1, 7.0, .32971028480559, 130.2016, 6.9345, 48.33167, 29.12703035, 88, .205,0.38709893, //Venus
   ...
   //planets[0] = Planet(1898e24, 1, 1.85061, 1.66602003028769, 130.2016, 6.9345, 49.57854, 286.4623, 687.0, 0.09341233, 1.52366231, //Jupiter
